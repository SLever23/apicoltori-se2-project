...
describe('Test task_logic of /tasks', () => {
    ...
    test('search invalid searchkey', () => {
        expect(tl.get_tasks(10)).toEqual([]);
        expect(tl.get_tasks(null)).toEqual([]);
        expect(tl.get_tasks(undefined)).toEqual([]);
    });
...
describe('Test task_logic of /tasks/id', () => {
    test('get task by id', () => {
        db.tasks = [];
        db.tasks.push({ id: 0, title: "the titolo 0", description: "the descrizione", topic: [], type: "true-false" });
        db.tasks.push({ id: 1, title: "the titolo 1", description: "the descrizione 1", topic: [], type: "true-false" });
    ...
    test(('update with valid tasks'), () => {
        ...
        tl.update_task({ id: null, title: "will this test work?", description: "will the description change?", topic: [], type: "multiple-choice", answers: ["true", "false", "it can't be said"] }, 0);
        expect(db.tasks[0]).toEqual({ id: 0, title: "will this test work?", description: "will the description change?", topic: [], type: "multiple-choice", answers: ["true", "false", "it can't be said"] });
    });
    ...
    test('delete task', () => {
        ...
        db.tasks.push({ id: 2, title: "the titolo 2", description: "the descrizione 2", topic: [], type: "true-false" });
        tl.delete_task(1);
        expect(db.tasks).toEqual([{ id: 0, title: "the titolo 0", description: "the descrizione 0", topic: [], type: "true-false" }, undefined,
        ...
        tl.delete_task(2);
        expect(db.tasks).toEqual([{ id: 0, title: "the titolo 0", description: "the descrizione 0", topic: [], type: "true-false" }, undefined, undefined]);
    });
});
